...
### 4. Chart Summary - Tooltip Causes Layout Shift
...
### 5. All Scans - No Auto-Scroll to Results
...
### 6. All Scans - Lock Inputs While Scan Is Running
...
### 7. Top Bandwidth IPs & Upload Payloads - Results Hard to Read
...
### 11. Top Bandwidth IPs - Export Should Be Excel Not CSV
The Top Bandwidth IPs scan exports to CSV. Both the UI and console output should produce a well-formatted Excel file instead.

### 12. IP Summary - Missing Status Updates During Export
...
### 13. ALB Requests Over Time Per Selected IP - Needs File Picker
...
### 14. ALB/IIS IP Summary UI - Source File Selection
...
### 15. WAF Blocked Summary - Results Not Meaningful Enough
The WAF blocked summary results are buried in the scan status card and only show a list of top blocks. The overall results need to be moved to the results section and presented in a more meaningful way (e.g. aggregate stats, visual breakdown). Exact approach TBD.

### 16. AbuseIPDB - Pull IPs from IIS Burst Cache
